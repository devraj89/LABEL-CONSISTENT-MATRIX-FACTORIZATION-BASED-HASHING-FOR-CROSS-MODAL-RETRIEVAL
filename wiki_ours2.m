...
for di = 1 : dtN
    ...
    RetrXs = cell(1, v+1);                            % Retrieval Set
    RetrXs{1} = I_tr;
    RetrXs{2} = T_tr;
    RetrXs{3} = convert_labels_to_1_of_K(L_tr);
    
    queryXs = cell(1, v+1);                           % Query Set
    queryXs{1} = I_te;
    queryXs{2} = T_te;
    ...
    for bi = 1 : bitN
        ...
        for ri = 1 : runtimes
            ...
            for si = 1 : 2
                ...
                % In this we do not do re-generation of the training hash
                % codes. That is why we use the learned hash codes of the
                % Stage 1 of our algorithm
